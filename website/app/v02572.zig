...
const html =
    ...
    \\    type: 'bar',
    \\    data: { labels: ["codedb (20)", "fff-mcp (fewer)", "ripgrep (2959)", "grep (2973)"], datasets: [{ data: [20, 8, 2959, 2973], backgroundColor: [green, "#3b82f6", "#9ca3af", gray], borderRadius: 4, barThickness: 32 }] },
